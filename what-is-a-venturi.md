...
### A Venturi Checklist:
- [ ] There is a fluid flowing with some initial pressure.
- [ ] The fluid flows into a constriction.
- [ ] The fluid pressure drops in the constriction.
- [ ] The fluid velocity increases in the constriction.
- [ ] Optional: If a siphon exists, then the siphon fluid is at a pressure that is higher than the low-pressure in the constriction.
